...
boot:
    ...
    int 0x13                            ; call bios
    jc boot                             ; if (cf), error - try resetting 
    ...
    mov track_num, 0                    ; reading 2nd sector past, track sector
    mov sector_num, 2                   ; sector to read (2nth sector)
    mov head_num, 0                     ; head num
    mov drive_num, 0                    ; drive num, drive 0 = floppy
